<template>
  <a-card :bordered="false">
            ...
            <a-col :md="6"
              ...
              <a-form-item label="数据状态">
                <a-input placeholder="请选择"
                         v-model="queryParam.stat"></a-input>
              </a-form-item>
            </a-col>
          </template>
          <a-col :md="6"
    ...
    <div class="table-operator">
      ...
      <a-button type="primary"
                icon="download"
                @click="handleExportXls('新闻资讯')">导出</a-button>
      <a-upload name="file"
    ...
    <!-- 表单区域 -->
    <news-modal ref="modalForm"
                @ok="modalFormOk"></news-modal>
  </a-card>
</template>
...
export default {
  ...
  data () {
    return {
      ...
      url: {
        list: "/siit/news/list",
        delete: "/siit/news/delete",
        deleteBatch: "/siit/news/deleteBatch",
        exportXlsUrl: "siit/news/exportXls",
        importExcelUrl: "siit/news/importExcel",
      },
    }
  },
  computed: {
