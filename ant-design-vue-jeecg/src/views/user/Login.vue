    ...
    <a-form :form="form"
      ...
      <a-tabs :activeKey="customActiveKey"
        ...
        <a-tab-pane key="tab1"
          ...
          <a-form-item>
            <a-input v-decorator="['password',validatorRules.password]"
                     size="large"
                     type="password"
                     autocomplete="false"
          ...
          <a-row :gutter="0">
            ...
            <a-col :span="10">
              <j-graphic-code @success="generateCode"
                              style="float: right"></j-graphic-code>
            </a-col>
          </a-row>
        ...
        <a-tab-pane key="tab2"
          ...
          <a-row :gutter="16">
            <a-col class="gutter-row"
                   :span="16">
              <a-form-item>
                <a-input v-decorator="['captcha',validatorRules.captcha]"
                         size="large"
                         type="text"
                         placeholder="请输入验证码">
                  <a-icon slot="prefix"
      ...
      <a-form-item>
        ...
        <router-link :to="{ name: 'alteration'}"
