...
$(function () {
    ...
    $.extend({
        getTag: function () {
            $.getJSON(
                "../inc/gettag.ashx"/*tpa=http://www.ti-un.net/inc/gettag.ashx*/,
                {
                    classid: $("#ClassID").val(),
                    tag: $("#Tag").val()
                },
        ...
        getData: function () {
            layer.load(1);
            $.getJSON(
                "http://www.ti-un.net/inc/GetCase.ashx",
                {
...
+ "<a href='http://www.ti-un.net/" + GetViewPage(json[i].c_id, json[i].c_Parentid) + "'  target='_blank'>"
+ "<figcaption><p><strong>VIEW</strong>DETAIL</p></figcaption>"
+ "<img onerror=\"'this.src='../src/images/case_img_3.jpg'/*tpa=http://www.ti-un.net/src/images/case_img_3.jpg*/\"  src='" + json[i].c_Titpic + "'  alt='case'>"
+ "</a>"
