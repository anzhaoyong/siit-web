...
function getpic(param) {
    if (param.length > 5) {
        ...
        return "../src/images/news_img.jpg"/*tpa=http://www.ti-un.net/src/images/news_img.jpg*/;
    }
}
...
$(function () {
    ...
    $.extend({
        getTag: function () {
            $.getJSON(
                "../inc/getClasslist.ashx"/*tpa=http://www.ti-un.net/inc/getClasslist.ashx*/,
                {
                    classid: 1
                },
                function (data) {
        ...
        getData: function () {
            layer.load(1);
            $.getJSON(
                "http://www.ti-un.net/inc/GetNewsList.ashx",
                {
    	...
    	"<li><a href='http://www.ti-un.net/Detail/" + json[i].c_id + "' target='_blank'>" +
...
"</a>"+
        "</li>"+
        "<li>"+
        	"<a href='http://www.ti-un.net/Detail/" + json[i].c_id + "' target='_blank'>" +
