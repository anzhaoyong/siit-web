    ...
    $.extend({
        GetTop1: function () {
            $.getJSON(
                ...
                "<h3><a href='http://www.ti-un.net/Detail/" + data[i].c_id + "' target='_blank'>" + data[i].c_Title + "</a></h3>" +
                "<p>" + data[i].c_Keyword + "</p> " +
                "<a class=\"enter\" href='http://www.ti-un.net/Detail/" + data[i].c_id + "' target='_blank'>more</a>");
                    });
                }
            );
        }
