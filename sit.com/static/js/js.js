...
function displayLoading(n, t, i) {
    i = i || "__progressbar__";
    var u = '<div class="UpdateProgressBar" id="' + i + '"><div><img src="/web_portal_newVersion/images/loading.gif" class="loading" /><img src="/web_portal_newVersion/images/trust.png" class="trust" /><div style="color:white;">' + (n || "") + "<\/div><\/div><\/div>", f = window.location.href.indexOf("target=MobileApply") >= 0, r;
...
function createIcon(n) {
    return new BMap.Icon("/web_portal_newVersion/images/mapcircle.png",new BMap.Size(n.w,n.h))
}
function showInfo() {
    initMap()
}
